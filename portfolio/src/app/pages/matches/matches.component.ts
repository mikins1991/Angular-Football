...
export class MatchesComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.apiService.getMatchTable().pipe(take(1)).subscribe((data) => this.onDataLiga(data));
        this.apiService.getDataClubLiga().subscribe((data) => this.onDataClub(data));
        this.apiService
            .getAllCompetitions()
            .pipe(take(1))
            .subscribe((data) => console.log('MatchesComponent -> ngOnInit -> data', data));
    }
}
