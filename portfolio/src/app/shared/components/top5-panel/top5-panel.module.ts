...
import { StandingsModule } from 'src/app/pages/standings-all/standings/standings.module';

@NgModule({
    declarations: [ Top5PanelContainer, Top5PanelComponent ],
    imports: [ CommonModule, MatButtonModule, AppRoutingModule, MatTabsModule, TableModule, StandingsModule ],
